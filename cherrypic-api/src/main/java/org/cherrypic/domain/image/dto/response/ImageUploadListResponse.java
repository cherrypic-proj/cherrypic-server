...
public record ImageUploadListResponse(
        ...
        @Schema(description = "업로드된 이미지들의 정보 리스트") List<Content> content) {
    public static ImageUploadListResponse of(List<Content> content, Boolean localImageDeletion) {
        return new ImageUploadListResponse(localImageDeletion, content);
    }

    @Schema(name = "ImageUploadListResponseContent")
